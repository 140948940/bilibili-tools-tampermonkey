import { GM_getValue, GM_setValue, GM_deleteValues } from '$'
...
export const getValue = (key: string, defaultValue?: any) => {
  try {
    return JSON.parse(GM_getValue(key)) || defaultValue
  } catch (e) {
    return defaultValue !== undefined ? defaultValue : GM_getValue(key)
  }
}

...
// import AlTools from '@/modules/default/AlTools/index'
// const otherModules = [AlTools]
// const otherModules =[]
import Logger from '@/utils/logger'
import mitt from '@/utils/mitt'
import { delayToNextMoment } from '@/utils/luxon/index'
import type {
  ModuleStatus,
...
import { deepestIterate, waitForMoment } from '@/utils/index'
import { useCacheStore } from './useCacheStore'
import { isSelfTopFrame } from '@/utils/dom'
import type BaseModule from '@/modules/BaseModule'
import ModuleCriticalError from '@/utils/error/ModuleCriticalError'
import ModuleError from '@/utils/error/ModuleError'
...
export const useModuleStore = defineStore('module', () => {
  // 所有模块的配置信息
  const moduleConfig = ref(Storage.getModuleConfig())
